...
<aside id="sidebar" class="bg-white dark:bg-gray-800 h-screen fixed border-r border-gray-200 dark:border-gray-700 transition-all duration-300 z-40 w-64">
    <div class="px-4 py-4">
        <div class="mb-6" id="sidebar-header">
            <div class="text-xl font-bold text-gray-900 dark:text-white">Admin Panel</div>
        ...
        <div class="mt-8 pt-4 border-t border-gray-200 dark:border-gray-700">
            <div class="text-xs font-semibold text-gray-400 dark:text-gray-500 mb-2 px-3 sidebar-text">SYSTEM</div>
            <div class="flex flex-col gap-1">
                <a href="#" class="px-3 py-2 text-sm text-gray-600 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-700 rounded-lg transition sidebar-text">Settings</a>
                <a href="#" class="px-3 py-2 text-sm text-gray-600 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-700 rounded-lg transition sidebar-text">Integrations</a>
            </div>
        </div>
    </div>
</aside>